...
# Database (use sqlite for now, or MySQL if you configure)
DATABASES = {
    'default': {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jjabay3@gmail.com'  # Your email here
EMAIL_HOST_PASSWORD = 'iogu hhkn qytf aqne'  # Your app password here
