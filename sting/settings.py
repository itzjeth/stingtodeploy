...
DEBUG = True
ALLOWED_HOSTS = ['https://stingcc.onrender.com/']  # Allow all hosts for Render deployment
...
# Database
# Using SQLite for simplicity; you can switch to MySQL/PostgreSQL if needed
DATABASES = {
    'default': {
